...
public final class XaiMeetingAnalyzer {
    ...
    private String request(String payload,String key) throws Exception{
        ...
        String prompt="Ты — аналитик и дизайнер бизнес-презентаций LiveLingo. Анализируй ТОЛЬКО предоставленную стенограмму и локальный отчёт. Не выдумывай факты, цифры, имена, сроки или причины. Если данных не хватает, прямо пиши 'не указано'. Сохраняй различие между спикерами и по возможности привязывай выводы к timestamp/спикеру из стенограммы. Ответ на русском.\n\n"
                +"Сначала сформируй СМЫСЛОВУЮ МОДЕЛЬ:\n"
                +"1) ТЕМА — одно предложение.\n"
                +"2) СЮЖЕТ — выбери реальную логику разговора: проблема→причины→решение, цифры→варианты→выбор, мозговой штурм, интервью, планёрка, спор, обучение или другое.\n"
                +"3) КАРТА РАЗГОВОРА — 4–10 тем/узлов, люди, решения, задачи, риски, вопросы.\n"
                +"4) ДОКАЗАТЕЛЬСТВА — важные реплики с speaker/timestamp, если они есть.\n\n"
                +"Затем сформируй ИНДИВИДУАЛЬНУЮ ПРЕЗЕНТАЦИЮ. Не используй фиксированный шаблон из одинаковых пяти слайдов. Количество слайдов 3–10 и структура должны зависеть от содержания разговора. Каждый слайд должен иметь: \n"
                +"• заголовок до 55 символов;\n"
                +"• визуальный тип: hero-number, comparison, timeline, decision-tree, quote, topic-map, people-map, matrix, process, action-board, risk-map, funnel, conclusion;\n"
                +"• 2–5 коротких конкретных пунктов;\n"
                +"• evidence: speaker/timestamp/реплика, если есть.\n\n"
                +"Не создавай пустые слайды. Не добавляй графики, если в разговоре нет цифр. Если был спор — покажи варианты. Если был план — покажи timeline. Если было много тем — покажи карту тем. Если была сильная фраза — сделай quote-слайд.\n\n"
                +"ФОРМАТ ОТВЕТА:\n"
                +"ТЕМА: ...\nСЮЖЕТ: ...\nКАРТА РАЗГОВОРА:\n- ...\n\nПРЕЗЕНТАЦИЯ:\nСЛАЙД 1 · Заголовок\nВизуал: ...\n• ...\nEvidence: ...\n\nСЛАЙД 2 ...\n\nДАННЫЕ ВСТРЕЧИ:\n"+clipped;
