...
public final class LiveSpeechRecognizer implements RecognitionListener {
    ...
    private final Context context; private final Listener listener; private SpeechRecognizer recognizer; private boolean running; private String detectedLanguage;
    ...
    public void stop() { running = false; if (recognizer != null) { recognizer.cancel(); recognizer.destroy(); recognizer = null; } }
